...
<body class="bg-light">
    ...
    <select name="id_reposicion" id="id_reposicion" class="form-select form-select-sm select2-buscable" required>
        ...
        <div class="table-responsive bg-white shadow-sm p-3">
            <table class="table table-sm table-bordered table-hover" style="font-size: 0.75rem;"> <a class="dropdown-item" href="#">Usuario: <?php echo $_SESSION["user_name"]; ?> - <?php echo $_SESSION["user_rol"]; ?> - ID <?php echo $_SESSION["user_id"]; ?></a>
