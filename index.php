...
<body>
  ...
  <?php
// Aseg迆rate de que la sesi車n est谷 iniciada antes de usar $_SESSION
// session_start(); // (si no est芍 ya en tu c車digo)
...
if (isset($_SESSION["user_rol"])) {
    ...
    // Si no hay rol definido, puedes redirigir o mostrar un navbar gen谷rico
    include 'navbar.php';
}
?>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card bg-success text-white text-center p-4">
                    ...
                    <?php
                        // Obtenemos el ID del usuario de la sesi車n
                        $id_usuario_sesion = 3;
